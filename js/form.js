...
// 1. показывать координаты в форме во время перемещения
// 2. изначальные координаты пина написать в форме
// 3. установить курсор над пином, убрать ограничения по ширине поля
